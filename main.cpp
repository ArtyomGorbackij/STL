...
int main (){
    ...
    Student v1("Алефиров", {{"Математика",3},{"Политология",4},{"Английский",5}}),
    v2("Андронов",{{"Математика",5},{"Политология",5},{"Английский",3}}),
    v3("Борисов",{{"Математика",4},{"Политология",5},{"Английский",5}});
